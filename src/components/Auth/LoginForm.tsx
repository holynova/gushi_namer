    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          disabled={loading}
          className="flex items-center justify-center gap-2 px-4 py-2.5 border border-matsu-border rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          ...
          <span className="text-sm font-medium text-matsu-text">Google</span>
        </button>
        ...
        >
          ...
          <span className="text-sm font-medium text-matsu-text">GitHub</span>
        </button>
      </div>
